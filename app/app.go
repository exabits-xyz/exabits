...
func New(
	...
	*/
	...
	app.ExabitsKeeper = *exabitsmodulekeeper.NewKeeper(
		appCodec,
		keys[exabitsmoduletypes.StoreKey],
		keys[exabitsmoduletypes.MemStoreKey],
		app.GetSubspace(exabitsmoduletypes.ModuleName),
	)
